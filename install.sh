...
#   wget -qO- https://raw.githubusercontent.com/TimUx/FestSchmiede/v2.3.13/install.sh | bash
#
...
#   FESTSCHMIEDE_VERSION              – Release-Tag (Standard: 2.3.13)
...
FESTSCHMIEDE_VERSION="${FESTSCHMIEDE_VERSION:-2.3.13}"
